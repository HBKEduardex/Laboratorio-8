...
class capturas:
    ...
    def run(self):
        print(f"Capturando automáticamente {self.max_capturas} imágenes...")

        while self.contador <= self.max_capturas:
            ...
            if cv2.waitKey(1) & 0xFF == ord('q'):
                break
            time.sleep(0.3)  # 300ms entre capturas, podés ajustarlo
